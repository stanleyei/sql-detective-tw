...
以 MariaDB 語法為基準的互動式 SQL 教學遊戲。玩家扮演潮港市警局的資料分析實習生，透過七個章節破解五起案件，並完成報到訓練與資料室實作；從 `SELECT` 一路學到 `JOIN`、子查詢與資料異動，約 8 小時課程。靈感來自 [SQL Murder Mystery](https://mystery.knightlab.com)（Knight Lab，CC BY-SA 4.0）。
