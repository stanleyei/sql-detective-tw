...
四段音樂皆取自 OpenGameArt.org，原作者以 **CC0 1.0（公眾領域貢獻宣告）** 釋出，可自由使用、修改與散布，無須標示出處；此處仍列出來源以便日後追溯與更換。
...
| `bgm-opening.*` | 開場演出（第 0 章片頭，一次性播放不循環） | Nighttime Solitude | celestialghost8 | https://opengameart.org/content/nighttime-solitude | 取前 46 秒，42 秒起 4 秒淡出；因片頭需要比背景更有存在感，正規化至 -19 LUFS（其餘為 -23）。原曲 35 秒的鼓組進入對齊片名卡 |
