...
GROUP BY station;</code></pre>` },
    ...
    { type: 'task', id: 'c3-t11', title: '他的悠遊卡', prompt: '從 <code>transit_card</code> 找出 <code>person_id</code> 為 14 的卡號 <code>card_id</code>。',
      ...
      check: { kind: 'value' } },
    { type: 'task', id: 'c3-t12', title: '他最常從哪站進站？', prompt: '用上一題的卡號，統計 <code>transit_log</code> 中該卡<strong>每個車站的進站次數</strong>（<code>direction = \'進站\'</code>），顯示 <code>station</code> 與次數（別名 <code>cnt</code>），次數<strong>由多到少</strong>排序。',
